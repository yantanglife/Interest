;define("translation:widget/translate/appGuide/appGuide",function(i,e,t){"use strict";var n=i("translation:widget/common/cookie"),o=$(".app-guide"),a=window.appVersion,p={init:function(){if(!/baiduinput/gi.test(window.navigator.userAgent)){var i=n.getCookie(a);
if(i)return void n.setCookie(a,"1",{expires:5184e6});_hmt.push(["_trackEvent","首页","首页app导流浮层展现量"]),o.removeClass("app-guide-hide"),n.setCookie(a,"1",{expires:5184e6}),this.bindEvent()
}},bindEvent:function(){$(".app-guide-close").on("click",function(){o.addClass("app-guide-hide")})}};$(function(){p.init()
}),t.exports=p});
...
;define("translation:widget/translate/details/dictionary/simplemeans",function(t,e){"use strict";var n=t("translation:widget/common/third_party/template"),a=t("translation:widget/common/soundURIGenerator"),o=t("translation:widget/translate/output/mouseover"),i=t("translation:widget/common/environment");
n.helper("uriComponentTrimAndEncode",function(t){return encodeURIComponent($.trim(t))});var r,s,u,c=!0,p=8,d=$("#left-result-container"),l={buildSimpleMeans:function(t){var e=t.data,a=(t.to,t.baikeImgUrl),o=2===parseInt(i.get("firstModuleId"),10);
d.append(n("tplDictionary",{isFirstCard:o}));var r,s={};s.tplData=e;var u=$(".select-from-language .language-selected").attr("data-lang"),c=$(".select-to-language .language-selected").attr("data-lang"),p=!1;
if(("en"===u&&"th"===c||"th"===u&&"en"===c)&&(s.tplData.show_th_detail=!0),s.tplData.show_sound=!1,("en"===u||"zh"===u)&&(s.tplData.show_sound=!0),e.tags){var l=[];
e.tags.core&&e.tags.core.length>0&&""!==e.tags.core[0]&&(l=l.concat(e.tags.core)),e.tags.other&&e.tags.other.length>0&&""!==e.tags.other[0]&&(l=l.concat(e.tags.other)),l.length>0&&(l=l.slice(0,6),s.tplData.coreTags=l)
}if(e.exchange)for(var h in e.exchange)e.exchange[h]&&(p=!0);s.tplData.showExchange=p,"zh"===u&&"en"===c&&(s.tplData.isZh2En=!0,_hmt.push(["_trackEvent","首页","Web中英词典释义卡片展现次数"])),s.tplData.symbols?(s.tplData.baikeImgUrl=a,s.tplData.isFirstCard=o,r=n("tplSimplemeans",s),a&&_hmt.push(["_trackEvent","首页","64_首页页面_Web词典释义卡片_图片展现次数"]),e.memory_skill&&_hmt.push(["_trackEvent","首页","73_首页页面_Web词典释义卡片_记忆技巧展现次数"]),e.derivative&&_hmt.push(["_trackEvent","首页","80_首页页面_Web词典释义卡片_派生词展现次数"])):s.tplData.content&&(r=n("tplOtherSimplemeans",s)),d.find(".dictionary-wrap").html(r),"英"!==$(".phonetic-transcription span").eq(0).text()&&$(".simple-dict").addClass("simple-dict-ztoe"),$(".simple-dict .op-repeat").length>0&&(_hmt.push(["_trackEvent","首页","web端复读按钮出现次数"]),this.bindRepeatEvents())
},bindEvents:function(){var t=this;$(".translate-wrap").on("click",".dictionary-wrap .op-sound",function(){t.timer&&clearTimeout(t.timer),t.clickSound({target:this})
...
})},clickSound:function(t){var e=$(t.target);this.judgeStopRepeat();var n=a.generateURI({lan:e.attr("data-sound-lan"),text:e.attr("data-sound-text")});
BTPM.setUrl(n);var o;e.addClass("op-sound-active"),o&&clearTimeout(o),o=setTimeout(function(){e.removeClass("op-sound-active")
},2e3),_hmt.push(["_trackEvent","首页","web端简明释义TTS"])},repeatSound:function(t){var e=this,n=$(t.target);if(n.hasClass("op-repeat-running"))o.isover({target:t.target,text:"复读"}),e.shutdownRepeat(),_hmt.push(["_trackEvent","首页","web端复读按钮停止点击"]);
else{if(e.shutdownRepeat(),p=8,n.addClass("op-repeat-running"),u=a.generateURI({lan:n.attr("data-sound-lan"),text:n.attr("data-sound-text")}),BTPM.setUrl(u),p--,o.isover({target:t.target,text:"停止复读"}),n.attr("data-hover-tip-text","停止复读"),"IE"===BTPM.stage){var i=n.siblings("b").text();
if(i&&i.length>0){i=i.match(/\[(.*)\]/)[1];var d=e.getRepeatDuration(i);r=setInterval(function(){return 1>p?void e.shutdownRepeat():(BTPM.setUrl(u),void p--)
},d)}}else c=!0,$(BTPM).off("ended.repeating").on("ended.repeating",function(){return c?1>p?void e.shutdownRepeat():void(s=setTimeout(function(){BTPM.setUrl(u),p--
},1200)):void 0});_hmt.push(["_trackEvent","首页","web端复读按钮播放点击"])}},shutdownRepeat:function(t){$(".op-repeat").removeClass("op-repeat-running").attr("data-hover-tip-text","复读"),t&&t.nopause||BTPM.doPause(),"IE"===BTPM.stage?clearInterval(r):(clearTimeout(s),c=!1,$(BTPM).off("ended.repeating"))
...
},isoverSound:function(t){if("hover"===i.get("soundTriggerMode")){var e=this;this.timer=setTimeout(function(){e.clickSound({target:t.target})
...
},shutdownAudio:function(){BTPM.doPause()}};$(function(){l.bindEvents()}),e.buildSimpleMeans=function(t){l.buildSimpleMeans(t)
},e.judgeStopRepeat=function(){l.judgeStopRepeat()},e.translateStopRepeat=function(){l.translateStopRepeat()},e.shutdownAudio=function(){l.shutdownAudio()
},e.shutdownRepeat=function(){l.shutdownRepeat()}});
...
return $(".output-correct-type-box input").each(function(t,e){var r=$(e);r.prop("checked")&&o.type.push(r.val())}),(e=$.trim(i.val()))&&(o.result=e),0!==o.type.length||e&&$.trim(e)!==$.trim(s)||(l=!1),o
...
s.on("click",function(){$(this).hasClass("manual-trans-btn-disable")||(_hmt.push(["_trackEvent","首页","16_首页页面_点击人工翻译按钮"]),l({from:$(".select-from-language .language-selected").attr("data-lang"),to:$(".select-to-language .language-selected").attr("data-lang"),query:r.getVal(),middlePageUrl:"http://fanyi-pro.baidu.com/middlepage?hmsr=%E7%99%BE%E5%BA%A6%E7%BF%BB%E8%AF%91&hmpl=%E5%9B%BA%E5%AE%9A%E5%85%A5%E5%8F%A3&hmcu=%E9%A6%96%E9%A1%B5%E6%8C%89%E9%92%AE&hmkw=&hmci=",$appendToEle:s}))
...
;define("translation:widget/translate/input/translate",function(t,a){"use strict";var e=t("translation:widget/translate/input/prompt"),n=t("translation:widget/translate/input/textarea"),r=t("translation:widget/common/util"),s=t("translation:widget/translate/output/output"),o=t("translation:widget/common/config/trans"),i=t("translation:widget/translate/input/processlang"),l=t("translation:widget/common/string"),u=t("translation:widget/translate/input/soundicon"),g=t("translation:widget/translate/input/hash"),c=t("translation:widget/common/environment"),d=t("translation:widget/translate/input/longtext"),p=t("translation:widget/common/sendLog"),y=t("translation:widget/translate/details/dictionary/simplemeans"),f=t("translation:widget/translate/history/history"),m=t("translation:widget/translate/input/pGrab"),h=t("translation:widget/translate/details/adLink/adLink"),w={onTrans:function(t){y.translateStopRepeat()||y.shutdownAudio();
...
var d=this,a=this.processQuery(a),p={from:g.fromLang,to:g.toLang,query:a,transtype:n,simple_means_flag:3,sign:m(a),token:window.common.token};
this.translateXHR&&4!==this.translateXHR.readyState&&this.translateXHR.abort(),this.translateXHR=$.ajax({type:"POST",url:"/v2transapi",cache:!1,data:p}).done(function(t){c.set("isInRtTransState",!0),d.translateSuccess(t,g.fromLang,g.toLang,a,l)
...
for(var l=r.length-1;l>=0;l--){var p=r[l],d=p.kind,m=p.type;if("file"===d){var g=p.getAsFile();if(m.startsWith("image/")){if(g){i=!0,o=g;
break}}else if(y.isSupportByDocTrans(m)&&window.common.docHit){if(g){s=!0,u=g;break}}else if("drop"===e&&window.common.docHit&&!y.isUrlFileInEdge(g)){y.logWrongFileFormat(g),alert("目前仅支持 "+(window.common.pdfHit?"pdf、":"")+"docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
break}}}}else for(var f=a.length-1;f>=0;f--){var w=a.item(f);if(w.type.startsWith("image/")){i=!0,o=w;break}if(y.isSupportByDocTrans(w.type)&&window.common.docHit){s=!0,u=w;
break}if("drop"===e&&window.common.docHit&&!y.isUrlFileInEdge(w)){y.logWrongFileFormat(w),alert("目前仅支持 "+(window.common.pdfHit?"pdf、":"")+"docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
...
var r=new Image;r.onload=function(){var t=this.src;setTimeout(function(){e.revokeObjectURL(t)},1e3)},r.src=n}function o(t){return L.compress(t,{maxWidth:1280,maxHeight:1280,convertSize:3e6}).catch(function(){return f(!1),Promise.reject()
...
},!1),o.open("POST","/getocr"),o.send(i)}).catch(function(t){return alert(t),f(!1),Promise.reject()})}function u(t){return new Promise(function(e,n){if(t.size>P)return _hmt.push(["_trackEvent","首页","57_首页页面_浏览器弹窗提示_图片大小超过10M"]),void n("您上传的图片已超过"+O+"M，请重新上传");
...
},s.onerror=function(){n("图片文件损坏，无法解析")},s.src=u.createObjectURL(t)}).catch(function(t){return alert(t),f(!1),!1})}function c(){var t=!1;
...
}function l(t){return t>=15&&4096>=t}function p(t){return D.includes(t)||"auto"===t?!0:(alert("当前语言不支持图片识别，请选择语言"),w.fromBtnClicked(),!1)
}function d(e,n){if(j.removeClass("with-loading-ocr-tip"),0!==e.errno||0===e.errno&&0===e.data.src.length){t("translation:widget/translate/input/clear").show(),k.set("shouldClearPromptOnInput",!0);
...
}else{var a=e.data.src.join(""),i=e.data.from,o=v.getElem();o.val(a),k.set("isProcessOcrResult",!0);var s=t("translation:widget/translate/input/events");
...
}}function m(){R.css("background-image","none"),j.removeClass("with-image"),R.data("file",null)}function g(){return $(".trans-input-wrap").hasClass("with-image")&&$("#image-holder").data("file")&&!$("#baidu_translate_input").val()?(h($("#image-holder").data("file"),!0),!1):!0
}function f(t){j.toggleClass("with-loading-ocr-tip",t),$("body").toggleClass("no-interaction",t),F=t}function _(t){return 4===t.length&&"string"===t[0].kind&&"text/plain"===t[0].type&&"string"===t[1].kind&&"text/html"===t[1].type&&"string"===t[2].kind&&"text/rtf"===t[2].type&&"file"===t[3].kind&&"image/png"===t[3].type
}var h=function(){var e=r(regeneratorRuntime.mark(function n(e,r){var a,c,l,m,g;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(f(!0),""===$("#baidu_translate_input").val()&&r||(a=t("translation:widget/translate/input/events"),a.onClearBtnClick()),c=$(".select-from-language .language-selected").attr("data-lang"),l=$(".select-to-language .language-selected").attr("data-lang"),p(c)){n.next=7;
break}return f(!1),n.abrupt("return");case 7:if(r){n.next=16;break}return n.next=10,u(e);case 10:if(m=n.sent){n.next=13;break
}return n.abrupt("return");case 13:return n.next=15,o(e);case 15:e=n.sent;case 16:return n.next=18,s(e,c,l);case 18:g=n.sent,r||(i(e),j.addClass("with-image")),d(g,c),f(!1);
case 22:case"end":return n.stop()}},n,this)}));return function(){return e.apply(this,arguments)}}(),w=t("translation:widget/translate/translang/fromlang"),v=t("translation:widget/translate/input/textarea"),k=t("translation:widget/common/environment"),x=t("translation:widget/common/third_party/image-compressor"),b=t("translation:widget/common/third_party/bowser"),E=t("translation:widget/translate/input/uploader"),y=t("translation:widget/translate/docTranslate/docTransUtil"),L=new x,j=$(".trans-input-wrap"),R=$("#image-holder"),C=!1,T=!1,U=0,F=!1,O=10,P=1048576*O,H=3,I=1e3*H,D=k.get("ocrLangList"),B=["png","jpg","bmp","jpeg"];
!function(){if("1"===window.common.ocrHit){var t=window.URL||window.webkitURL;t&&"function"==typeof t.createObjectURL&&!b.msie&&!b.ucbrowser&&window.FormData&&"undefined"!=typeof window.FileReader&&("draggable"in document.createElement("span")&&(T=!0),b.check({firefox:"41",chrome:"13",opera:"12.1"},!0)&&(C=!0))
}}();var S=j.find(".textarea-bg .prompt-text");window.common.docHit?C?(S.text("输入文字、网址 / 粘贴图片 / 拖入文档"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址 / 粘贴图片 / 拖入文档"])):T?(S.text("输入文字、网址 / 拖入图片、文档"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址 / 拖入图片、文档"])):(S.text("输入文字、网址"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址"])):C?(S.text("输入文字、网址或粘贴图片 即可翻译"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址或粘贴图片 即可翻译"])):T?(S.text("输入文字、网址或拖拽图片 即可翻译"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址或拖拽图片 即可翻译"])):(S.text("输入文字或网址 即可翻译"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址 即可翻译"])),n.exports={handle:a,pasteCompatibility:C,dragCompatibility:T,clearInputImage:m,checkAndTranslateThumbnail:g,processImgFile:h}
});
...
},clickFromItem:function(t){a.fromlangItemSelect({target:$(t.target),trans:!0}),_hmt.push(["_trackEvent","首页","web端点击源语言列表item"])
...
;define("translation:widget/footer/follow/follow",function(o,t){"use strict";function i(){$("#follow-btns").on("click",e),$("#fdialog-wrap").on("click",a),$(".footer").removeClass("visibilit-hide")
}function e(o){var t=$(o.target),i=t.attr("data-pos"),e=t.attr("title");if("undefined"!=typeof i){3!==+i&&l(+i);var a="Web翻译"+e+"点击";
_hmt.push(["_trackEvent","follow icons",a])}}function l(o){$(".fdialog-cont").addClass("hide"),$(".cont-"+o).removeClass("hide"),$("#follow-dialog").removeClass("hide")
}function a(o){var t=o.target;return t===this||t===$("#fdialog-close").get(0)?($("#follow-dialog").addClass("hide"),o.stopPropagation(),!1):void 0
}t.init=function(){i()}});
